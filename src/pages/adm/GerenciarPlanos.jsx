        ...
        <div className="glass-panel rounded-3xl p-4 sm:p-6 space-y-4">
          ...
          {criando && (
            <form
              ...
              className="bg-surface-container-highest/20 rounded-2xl p-4 sm:p-5 space-y-5 border border-veu/10"
            >
              <div className="flex flex-wrap items-center justify-between gap-3 border-b border-veu/5 pb-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
              {planos.map((plano) => (
                ...
                >
                  ...
                  {/* Footer do card */}
                  <div className="flex flex-wrap items-center justify-between gap-2 px-4 py-3 border-t border-veu/5 bg-veu/2">
