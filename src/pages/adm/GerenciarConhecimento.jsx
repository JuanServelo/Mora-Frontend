...
// Página ADMIN — Base de Conhecimento (FAQ, global).
// Os avisos moram em GerenciarComunicados: publicar e ver quem leu são a
// mesma tarefa, e ficavam em itens de menu diferentes.
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <header>
          ...
          <p className="text-on-surface-variant text-sm mt-1">
            Artigos de regras, manuais e FAQ. Os avisos do condomínio ficam em
            Comunicados.
          </p>
        </header>
